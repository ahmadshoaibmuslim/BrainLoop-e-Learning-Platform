    ...
    const fetchCourse = () => {
        useAxios()
            ...
            .then((res) => {
                ...
                setIsLoading(false);
                fetchRecommendedCourses(res.data.id);
            })
            .catch((err) => {
                                                                ...
                                                                <div className="col-md-7">
                                                                    ...
                                                                    <div className="card-body">
                                                                        ...
                                                                        <ul className="list-inline mb-3">
                                                                            ...
                                                                            <li className="list-inline-item me-3">
                                                                                <a href={course.teacher.facebook}>
                                                ...
                                                <div className="card shadow p-2 mb-4 z-index-9">
                                                    <div className="overflow-hidden rounded-3">
                                                        <img src={course.image}
                                                            className="card-img" alt="course image" />
                                                        <div className="m-auto rounded-2 mt-2 d-flex justify-content-center align-items-center" style={{ backgroundColor: "#ededed" }}>
                                                            {course.file_url ? (
                                                                <>
                                                                    <a data-bs-toggle="modal" data-bs-target="#exampleModal" href="#" className="btn btn-lg text-danger btn-round btn-white-shadow mb-0" data-glightbox="" data-gallery="course-video">
                                                                        <i className="fas fa-play" />
                                                                    </a>
                                                                    <span data-bs-toggle="modal" data-bs-target="#exampleModal" className='fw-bold'>Course Introduction Video</span>
                                                                </>
                                                            ) : (
                                                                <span className='fw-bold text-muted'>No video available</span>
                                                            )}
                                                                ...
                                                                <div className="modal-dialog modal-lg">
                                                                    <div className="modal-content">
                                                                        ...
                                                                        <div className="modal-body">
                                                                            {course.file_url ? (
                                                                                <ReactPlayer url={course.file_url} controls={true} width="100%" height="400px" />
                                                                            ) : (
                                ...
                                <div key={recCourse.id} className="col">
                                    ...
                                    <div className="card card-hover">
                                        <Link to={`/course-detail/${recCourse.slug}/`}>
                                            <img
                                                src={recCourse.image || "https://via.placeholder.com/300"} 
                                                alt="course"
                                        ...
                                        <div className="card-body">
                                            <div className="d-flex justify-content-between align-items-center mb-3">
                                                <span className="badge bg-info">{recCourse.level || "Intermediate"}</span>
                                                <a href="#" className="fs-5">
                                                    <i className="fas fa-heart text-danger align-middle" />
                                                </a>
                                            </div>
                                            <h4 className="mb-2 text-truncate-line-2">
                                                <Link to={`/course-detail/${recCourse.slug}/`} className="text-inherit text-decoration-none text-dark fs-5">
                                                    {recCourse.title}
                                                </Link>
                                            </h4>
                                            <small>By: {recCourse.instructor || "Unknown"}</small> <br />
                                            <small>{recCourse.students || "0"} Students</small> <br />
                                            <div className="lh-1 mt-3 d-flex">
                                                <span className="align-text-top">
                                                    <span className="fs-6">
                                                        {[...Array(5)].map((_, i) => (
                                                            <i key={i} className={`fas fa-star ${i < Math.round(recCourse.rating) ? "text-warning" : "text-muted"}`}></i>
                                                        ))}
                                                    </span>
                                                </span>
                                                <span className="text-warning">{recCourse.rating}</span>
                                                <span className="fs-6 ms-2">({recCourse.reviews || 0})</span>
                                            </div>
                                        </div>
                                        {/* Card Footer */}
